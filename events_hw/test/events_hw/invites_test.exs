defmodule EventsHw.InvitesTest do
  use EventsHw.DataCase
  ...
  describe "invites" do
    ...
    @valid_attrs %{comments: "some comments", response: "some response"}
    @update_attrs %{comments: "some updated comments", response: "some updated response"}
    @invalid_attrs %{comments: nil, response: nil}
    ...
    test "create_invite/1 with valid data creates a invite" do
      ...
      assert invite.comments == "some comments"
    ...
    test "update_invite/2 with valid data updates the invite" do
      ...
      assert invite.comments == "some updated comments"
